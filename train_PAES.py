...
def main():
    ...
    #     print("Test prompt id is {} of type {}".format(test_prompt_id, type(test_prompt_id)), file=file0)
    #     print("Attribute: {}".format(attribute_name), file=file0)
    #     print("Seed: {}".format(seed), file=file0)
    ...
    train_data['y_scaled'] = get_single_scaled_down_score(train_data['data_y'], train_data['prompt_ids'],
                                                          attribute_name)
