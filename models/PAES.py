...
from custom_layers.convnext import Block
# from custom_layers.mogrifier import ParaphraseDetector
from custom_layers.mogrifier import MogrifierLSTM
...
def build_PAES(pos_vocab_size, maxnum, maxlen, readability_feature_count, linguistic_feature_count,
    ...
    # pos_zcnn = EncoderBlock(conv_num=4, ch_num=96, k=7, length=800)
    pos_zcnn = Block(name='Block')(pos_resh_W)
    ...
    pos_hz_lstm1 = MogrifierLSTM()(pos_avg_zcnn)
    pos_avg_hz_lstm = Attention(name='pos_avg_hz_lstm')(pos_hz_lstm1)
...
configs = Configs()
model = build_PAES(100, 97, 50, 100, 100, configs)
